...
const schoolWithArrow = () => {return "Novi Hogeschool"; }

console.log(getSchool());
console.log(schoolWithArrow());
...
function compliment() {
  return "Lekker bezig met die functies, Rick!";
}

const shortCompliment = () => { return "Lekker bezig hoor!"; }

console.log(compliment());
console.log(shortCompliment());
...
const getDetails = () => {
  return {firstname: 'Rick', lastName: 'Jonkman'}
}
